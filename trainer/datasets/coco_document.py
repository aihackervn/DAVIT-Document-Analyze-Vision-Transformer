...
import trainer.datasets.transforms as T
...
def build(image_set, args):
    ...
    dataset = DocumentAnalyzeDataset(img_folder, ann_file, transforms=make_coco_transforms(image_set), return_masks=args.masks)
    return dataset